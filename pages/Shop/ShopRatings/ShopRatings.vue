      ...
      <div class="ratingselect" v-if="ratings">
        <div class="rating-type border-1px">
          ...
          <span class="block positive" :class="{active: selectType===0}" @click="setSelectType(0)">
            满意<span class="count">{{positiveLength}}</span>
          </span>
          <span class="block negative" :class="{active: selectType===1}" @click="setSelectType(1)">
            不满意<span class="count">{{ratings.length-positiveLength}}</span>
          </span>
        </div>
    ...
    computed: {
      ...
      filterRatings(){
        ...
        return ratings.filter((ele)=>{
          ...
          //   }
          // }
          return (selectType===2 || selectType === ele.rateType) && (!onlyContent || ele.text.length>0)
